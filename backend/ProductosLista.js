...
const productos = [//se crea la lista de productos
  { 
    ...
    precio: "$250", 
    img: "public/img/Aparador Uspallata.png",
  ...
  { 
    ...
    precio: "$400", 
    img: "public/img/Biblioteca Recoleta.png",
  ...
  { 
    ...
    precio: "$150", 
    img: "public/img/Butaca Mendoza.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Escritorio Costa.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Mesa Comedor Pampa.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Mesa de Centro Araucaria.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Mesa de Noche Aconcagua.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Silla de Trabajo Belgrano.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Sillas Córdoba.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Sillón Copacabana.png",
  ...
  { 
    ...
    precio: "$600", 
    img: "public/img/Sofá Patagonia.png",
